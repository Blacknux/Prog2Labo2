...
namespace Clase07
{
    ...
    public class Tempera
    {
        ...
        {
            if(t.Equals(null) || t1.Equals(null))
            {
                return false;
            }
            else
        ...
        public string Marca
        {
            ...
            // Se pueden comentar alguno de los 2 bloques y generamos una propiedad de lectura solament o de escritura
            //Si estan los dos es RW
            set
            {
                this._marca = value;
            }
